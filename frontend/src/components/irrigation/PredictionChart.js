                ...
                <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                            ...
                            <XAxis dataKey="name" stroke="hsl(var(--chart-axis))" fontSize={12} tickLine={false} axisLine={false} />
                            <YAxis stroke="hsl(var(--chart-axis))" fontSize={12} tickLine={false} axisLine={false} domain={[0, 100]} tickFormatter={(value) => `${value}%`} />
                            <Tooltip
                                contentStyle={{
                            ...
                            {/* Threshold Lines */}
                            <ReferenceLine y={60} label={{ value: "Max Optimal", fill: "hsl(var(--chart-axis))", fontSize: 10 }} stroke="green" strokeDasharray="3 3" />
                            <ReferenceLine y={40} label={{ value: "Min Optimal", fill: "hsl(var(--chart-axis))", fontSize: 10 }} stroke="green" strokeDasharray="3 3" />
                            <ReferenceLine y={30} label={{ value: "Stress", fill: "red", fontSize: 10 }} stroke="red" strokeDasharray="3 3" />
