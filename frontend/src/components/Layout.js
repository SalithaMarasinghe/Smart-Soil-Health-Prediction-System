...
import { Home, Sprout, Droplets, BarChart3, LogOut, Droplet, Beaker, Activity } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex items-center gap-1">
                {navItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-full font-medium text-sm ${isActive
                ...
                <button
                  onClick={onLogout}
                  className="flex items-center gap-2 px-4 py-2 rounded-full font-medium text-sm text-muted-foreground hover:text-foreground hover:bg-muted"
                >
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`flex flex-col items-center justify-center py-2 px-1 rounded-lg ${isActive
