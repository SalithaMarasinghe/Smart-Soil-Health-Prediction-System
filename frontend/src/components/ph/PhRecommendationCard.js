                ...
                <Accordion type="single" collapsible defaultValue="short">
                    ...
                    <AccordionItem value="medium">
                        ...
                        <AccordionContent className="pl-8 space-y-2 text-sm">
                            ...
                            <p className="text-xs text-green-600 dark:text-green-400 mt-1">Expected Effect: {medium_term.effect}</p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="long">
                        ...
                        <AccordionContent className="pl-8 space-y-2 text-sm">
                            ...
                            <div className="bg-blue-50 dark:bg-blue-950/30 p-2 rounded text-blue-800 dark:text-blue-300 text-xs">
                                {long_term.reason}
                            </div>
                        </AccordionContent>
                    </AccordionItem>
