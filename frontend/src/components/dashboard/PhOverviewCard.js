...
const PhOverviewCard = ({ data }) => {
    ...
    return (
        <Card className={`h-full border-t-4 hover:shadow-md transition-shadow duration-200 ${isOptimal ? "border-t-green-500" : "border-t-orange-500"}`}>
            ...
            <CardContent>
                <div className="flex justify-between items-end mb-4">
                    ...
                    <div className="text-right">
                        <div className="flex items-center gap-1 justify-end text-sm text-orange-500 font-medium">
